...
import bg from '../../assets/img/thumb/blog-details.jpg'
...
export default function BlogDetailsV1() {
            ...
            <div className="max-w-[940px] mx-auto">
                <div data-aos="fade-up">
                    <ul className="flex items-center gap-[10px] flex-wrap">
                        ...
                        <li><Link to="/blog-v1" className="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum">{data?.tag ? data?.tag : 'Interior'}</Link></li>
                    </ul>
                    <h1 className="text-2xl leading-snug sm:text-3xl sm:leading-snug md:text-[40px] mt-4 md:mt-6 md:leading-snug">{data?.title ? data?.title :'The Importance of Choosing the Right Furniture'} </h1>
                ...
                <div className="s-py-50" data-aos="fade-up" data-aos-delay="100">
                    <img className="w-full h-[445px] object-cover bg-center" src={data?.image ? data?.image : bg} alt="blog-details"/>
                        ...
                        return(
                            <div className="md:max-w-[390px] w-full" key={index}>
                                ...
                                <div className="group flex sm:items-center gap-[15px]">
                                    <Link to="#" className="max-w-[80px] h-auto sm:max-w-[114px] w-full flex-none block">
                                    ...
                                    <div className="flex-1">
                                        <ul className="flex items-center gap-[10px] flex-wrap">
                                            ...
                                            <li><Link to="/blog-v1" className="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum group-hover:bg-primary group-hover:text-white duration-300">{item.tag}</Link></li>
                                        </ul>
                ...
                <div className="pt-3 max-w-[500px] mx-auto" data-aos="fade-up">
     ...
     <div className="s-py-100">
        <div className="container-fluid">
            <div className="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                <div>
                    <img src={about} className='size-16 mx-auto' alt="" />
                </div>
