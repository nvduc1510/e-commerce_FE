    ...
    <>
            ...
            <div className="container-fluid"  data-aos="fade-up" data-aos-delay="100">
                <div className="max-w-[1720px] mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2">
                    <div className="lg:bg-[#F8F8F9] lg:dark:bg-dark-secondary lg:pr-10 2xl:pr-0">
                        <OwlCarousel {...options} className="about-slider owl-carousel h-full">
                            <div><img className="object-cover w-full" src={bg1} alt="about"/></div>
                            <div><img className="object-cover w-full" src={bg2} alt="about"/></div>
                            <div><img className="object-cover w-full" src={bg3} alt="about"/></div>
                        </OwlCarousel>
                    </div>
        ...
        <div className="container-fluid"  data-aos="fade-up" data-aos-delay="300">
            <div className="bg-overlay before:bg-title before:bg-opacity-20 h-64 sm:h-96 lg:h-[650px] flex items-center justify-center max-w-[1720px] mx-auto" style={{backgroundImage:`url(${bg4})`}}>
                <Link to="#" onClick={() => setOpen(true)} className="popup-video w-12 sm:w-[70px] h-12 sm:h-[70px] rounded-full bg-white dark:bg-title flex items-center justify-center">
