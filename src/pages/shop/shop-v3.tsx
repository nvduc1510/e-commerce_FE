    ...
    <>
        ...
        <div className="s-py-100-50 overflow-hidden">
            <div className="relative">
                <div>
                    <button onClick={goToPrevSlide} className="absolute top-1/2 transform -translate-y-1/2 left-0 z-10 shop_prev w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-white duration-300 bg-title bg-opacity-90 hover:bg-primary p-2">
                    ...
                    <button onClick={goToNextSlide} className="absolute top-1/2 transform -translate-y-1/2 z-10 right-0 shop_next w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-white duration-300 bg-title bg-opacity-90 hover:bg-primary p-2">
                        <svg className="fill-current" width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="container" data-aos="fade-up" data-aos-delay="100">
                    <OwlCarousel {...option} ref={carouselRef} className="owl-carousel shop-v3-slider max-w-[1440px] mx-auto" >
