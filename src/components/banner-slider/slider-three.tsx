        ...
        <div className="max-w-[1720px] mx-auto">
            <div className="xl:max-w-[800px] 2xl:max-w-[1180px] ml-auto flex items-center justify-between gap-10 flex-col sm:flex-row">
                <div className="max-w-[285px] md:max-w-[364px] w-full sm:pb-12">
                    <OwlCarousel loop items={1}  autoplay={false} autoplayTimeout={8000} autoplaySpeed={3000} className="carousel-slider-one home-v5-banner-slider owl-carousel sm:h-[500px] md:h-[600px] xl:h-[765px] pb-8 sm:pb-0">
                        <div className="max-w-[200px] md:max-w-[240px] mx-auto lg:w-[300px] flex-none crsl-slider-one-thumb">
                        ...
                        <div className="max-w-[240px] mx-auto lg:w-[326px] flex-none crsl-slider-one-thumb pt-12 sm:pt-[100px]">
                            <div className="relative h-[350px] md:h-[500px] xl:h-auto">
                ...
                <div className="pt-0 pb-12 md:pb-[70px] lg:pb-8 2xl:pb-52 hidden">
                    <OwlCarousel loop items={1}  autoplay={false} autoplayTimeout={8000} autoplaySpeed={3000} className="carousel-slider-one home-v5-banner-slider owl-carousel">
