...
export default function SliderTwo() {
  return (
    <OwlCarousel loop items={1}  autoplay={false} autoplayTimeout={8000} autoplaySpeed={2000} className="home-v3-banner-slider owl-carousel pb-12 lg:pb-0" >
        <div className="lg:flex items-center gap-8 xl:gap-16 2xl:gap-24">
            <div className="lg:w-[55%] relative before:absolute before:w-1/2 before:h-full before:top-0 before:right-0 slider-gradient-overlay crsl-slider-thumb max-h-[500px] lg:max-h-full before:hidden lg:before:block">
